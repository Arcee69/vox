        ...
        <div className='w-full '>
            ...
            >
                <div className='flex flex-col gap-5 w-full mt-10 lg:w-5/12'>
                    <p className='font-bold text-[#fff] font-satoshi text-center lg:text-left text-[40px] lg:text-[64px]'>VoxScribe</p>
                    <p className='text-[#fff] text-[24px] text-center lg:text-left lg:text-[32px] font-satoshi'>Your expert partner for impactful press releases.</p>
                </div>

                <div className='w-full hidden mt-10 w-6/12 bg-[#00040F] rounded-3xl lg:flex flex-col items-center gap-4 p-[50px]'>
                    <p className='font-satoshi text-center text-base  text-[#fff]'>Get audio transcription now</p>
                    <textarea 
                        type='text'
                        value={transcript}
            ...
            <div className='w-11/12 mx-auto lg:hidden bg-[#00040F] rounded-3xl flex flex-col gap-4 p-[50px]'>
                <p className='font-satoshi text-center text-base lg:text-[18px] text-[#fff]'>Get audio transcription now</p>
                <textarea 
                    type='text'
                    value={transcript}
                    className='w-full lg:w-[491px] border border-[#fff] opacity-10 outline-none h-[189px] p-4 font-satoshi rounded-lg'
            ...
            <div className='mt-[60px] mb-[115px] gap-[50px] lg:gap-[154px] flex flex-col w-full'>
                <div className='w-10/12 mx-auto flex flex-col gap-[32px] '>
                    <p className='text-[28px] lg:text-[48px] font-satoshi font-bold text-[#1C1C1C]'>Anybody can use Voxscribe</p>
                    <div className='grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-[56px] items-center'>
                        ...
                        <div className='flex flex-col items-start gap-3 lg:gap-6 w-full lg:w-[278px]'>
                            ...
                            <p className='font-normal font-satoshi text-[#363637]'>
                                Enhance lessons by converting educational material into multilingual audio, 
                                perfect for global classrooms.
                            </p>
                        </div>
                        <div className='flex flex-col items-start gap-3 lg:gap-6 w-full lg:w-[278px]'>
                        ...
                        <div className='flex flex-col items-start gap-3 lg:gap-6 w-full lg:w-[278px]'>
                            ...
                            <p className='text-[#1C1C1C] font-bold font-satoshi text-[20px] lg:text-[24px]'>Publishers</p>
                            <p className='font-normal font-satoshi text-[#363637]'>
                ...
                <div className='w-10/12 mx-auto flex flex-col gap-[32px] '>
                    <p className='text-[#1C1C1C] font-bold font-satoshi text-[28px] lg:text-[48px]'>Why choose Voxscribe?</p>
                    <div className='flex flex-col lg:flex-row items-center gap-6 lg:gap-[91px] '>
                        ...
                        <div className='flex flex-col gap-[48px] w-full lg:w-6/12'>
                            <div className='flex gap-6 flex-col'>
                                <img src={Monitor} alt='Monitor' className='w-6 h-6'/>
                                <p className='text-[#1C1C1C] font-satoshi font-bold text-[24px]'>Lifelike Speech</p>
                                <p className='font-medium font-satoshi text-base text-[#363637]'>
                                    Create natural, human-like audio that sounds as if it were spoken by a real person, 
                                    complete with emotions and inflections.
                                </p>
                            </div>
                            <div className='flex gap-6 flex-col'>
                                <img src={Chart} alt='Chart' className='w-6 h-6'/>
                                <p className='text-[#1C1C1C] font-satoshi font-bold text-[24px]'>Instant Voice Creation</p>
                                <p className='font-medium font-satoshi text-base text-[#363637]'>
                                    Upload text, select your preferred voice, 
                                    and generate professional-quality speech in seconds.
                                </p>
                            </div>
                            <div className='flex gap-6 flex-col'>
                                <img src={Data} alt='Data' className='w-6 h-6'/>
                                <p className='text-[#1C1C1C] font-satoshi font-bold text-[24px]'>Customizable Voices </p>
                                <p className='font-medium font-satoshi text-base text-[#363637]'>
                                    Choose the tone, pace, and style that perfectly fits your message, 
                                    ensuring it hits just the right note.
                                </p>
                            </div>
                        </div>
                        <img src={Shake} alt='Shake' className='w-[562px] h-[572px] hidden lg:flex' />
                    </div>
                </div>
