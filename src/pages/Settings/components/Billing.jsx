...
const Billing = () => {
  return (
    <div className='flex flex-col gap-[13px]'>
        ...
        <hr />
        <div className='bg-[#fff] rounded-lg w-[760px] flex flex-col'>
            <div className='my-6 px-6 flex flex-col gap-6'>
                <div className='flex justify-between'>
                    ...
                    <p className='font-inter text-[48px] font-semibold leading-[60px]'>₦5000<span className='text-[#667085] font-inter font-medium text-base'>per month</span></p>
                </div>
