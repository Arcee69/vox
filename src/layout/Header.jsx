  ...
  return (
    ...
    >
        ...
        <div className='flex items-center gap-[48px]'>
            ...
            <button type='button' className='bg-[#FF6600] cursor-pointer rounded-3xl w-[200px]  p-2 flex items-center justify-center h-[54px]' onClick={() => setOpen(true)}>
              <p className='text-[#FFF] font-poppins text-[20px] font-medium'>Get In Touch</p>
            </button>
        </div>
